    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-white px-6">
                ...
                <Button className="mt-8 bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 hover:from-yellow-500 hover:to-rose-600 text-white font-semibold px-8 py-3 rounded-full">
                    Explore Tours
                </Button>
            </div>
        </section>
