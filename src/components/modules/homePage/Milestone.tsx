...
const Milestone = () => {
    ...
    return (
        <div className='bg-white'>
            {/* <div>
                <h1 className='text-2xl md:text-3xl lg:text-4xl pt-10 lg:pt-20 lg:w-[40%] mx-auto text-center'>
