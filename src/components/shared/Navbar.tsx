...
const navigationLinks = [
  ...
  { href: "/destination", label: "Destination", role: "PUBLIC" },
      ...
      <div className="container mx-auto px-4 flex h-16 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Popover>
            ...
            <PopoverContent
              align="start"
              className="w-36 p-1 md:hidden bg-black/80 text-white backdrop-blur-md border border-white/10"
            >
...
//     <header className="border-b">
//       <div className="container mx-auto px-4 flex h-16 items-center justify-between gap-4">
//         {/* Left side */} want to add here only logo and mobile menu
//         the logo url - https://res.cloudinary.com/dh3ej57qw/image/upload/v1762282647/dream_tour_logo_bjkrdj.png
//         <div className="flex items-center gap-2">
//           {/* Mobile menu trigger */}
//           <Popover>
//             <PopoverTrigger asChild>
...
//         {/* middle side */}
//         <div>
//                 wants add here all nav link
//         </div>

//         {/* Right side */} want to add here mode toggle and login logout button
//         <div className="flex items-center gap-2">
//           <ModeToggle />
//           {
